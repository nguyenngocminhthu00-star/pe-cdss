...
<style>
    ...
    h1.main-title {
        font-size: 3.20rem !important; /* Prominent and massive as in v12/v14! */
        color: #1e3d59 !important; /* Original deep blue color */
...
def render_sub_header(title, sub_step_id, session_key):
    ...
    st.markdown(f"<div class='{wrapper_class}'>", unsafe_allow_html=True)
    if st.button(f"{arrow} {title}", key=f"btn_{session_key}_{sub_step_id}"):
